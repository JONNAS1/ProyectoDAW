...
--
-- Indices de la tabla `bloques_notas`
--
...
--
-- Indices de la tabla `fichas_tags`
--
...
--
-- AUTO_INCREMENT de la tabla `bloques_notas`
--
ALTER TABLE `bloques_notas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `fichas_tags`
--
ALTER TABLE `fichas_tags`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `bloques_notas`
--
ALTER TABLE `bloques_notas`
...
--
-- Filtros para la tabla `fichas_tags`
--
ALTER TABLE `fichas_tags`
